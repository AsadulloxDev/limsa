    ...
    <div className='bg-[#212121] w-[100%] h-auto pb-[100px] pl-[30px]'>
        ...
        <div className='grid grid-cols-3'>
            <div className='w-[460px] mt-[30px]'>
                ...
                <p><a className='font-500 text-center text-white' href="https://www.ataevbahodirbuild.uz/">Ataev Bahadir Build - quality construction and repair services! Choose us, create the house of your dreams.</a></p>
